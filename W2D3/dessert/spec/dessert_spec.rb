...
describe Dessert do
  ...
  describe "#mix!" do
    it "shuffles the ingredient array" do
      ingredients = ["flour", "eggs", "chocolate chips", "sugar"]

      ingredients.each { |part| cookie.add_ingredient(part) }
  ...
  describe "#serve" do
    it "contains the titleized version of the chef's name" do
      allow(chef).to receive(:titleize).and_return("Chef Todd")
      expect(cookie.serve).to eq("Chef Todd has made 12 Cookies!")
    end
  end
